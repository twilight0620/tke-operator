...
// NetworkSettings contains parameters for auto-creating VPC and subnet
// when ClusterBasicSettings.VpcID or ClusterCIDRSettings.SubnetID is empty.
// VPC/Subnet names are auto-generated by the backend (e.g. Default_VPC_<random>).
...
type TKEClusterConfigStatus struct {
	...
	CreatedVpcID    string `json:"createdVpcId,omitempty"`
	CreatedSubnetID string `json:"createdSubnetId,omitempty"`
}
